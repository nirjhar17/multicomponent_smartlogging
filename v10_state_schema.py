...
class GraphState(TypedDict):
    ...
    Attributes:
        ...
        ansible_output: Optional structured Ansible remediation (dict)
        ansible_formatted: Optional formatted text with BEGINRCA/ENDPLAYBOOK delimiters
    ...
    # Generation
    generation: str
    ansible_output: Optional[Dict[str, Any]]  # Structured Ansible remediation
    ansible_formatted: Optional[str]  # Formatted text with delimiters
